...
def get_preprocessed_enron1():
    ...
    return enron1_preprocess, enron1_preprocessed_X, enron1_preprocessed_y

def get_preprocessed_enron2():
    ...
    return enron2_preprocess, enron2_preprocessed_X, enron2_preprocessed_y

def get_preprocessed_enron3():
    ...
    return enron3_preprocess, enron3_preprocessed_X, enron3_preprocessed_y  

def get_preprocessed_enron4():
    ...
    return enron4_preprocess, enron4_preprocessed_X, enron4_preprocessed_y

def get_preprocessed_enron5():
    ...
    return enron5_preprocess, enron5_preprocessed_X, enron5_preprocessed_y

def get_preprocessed_enron6():
    ...
    return enron6_preprocess, enron6_preprocessed_X, enron6_preprocessed_y
